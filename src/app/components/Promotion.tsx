 ...
 return <>
    ...
    <div className="group flex md:flex-row flex-col relative  h-3/4 w-3/4 items-center text-center justify-between mt-20">
        <div className="w-full h-1/2 md:w-1/2 md:h-full  justify-center items-center flex flex-col md:mr-10">
                <h1 className='text-vln-white'>Başlık 1</h1>
                <p className='text-vln-white'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Distinctio, voluptas?</p>
        </div>
...
<section className="h-128 relative bg-gradient-to-t from-white to-stone-900 to-5% items-center justify-center flex  pb-10">
<div className="group flex md:flex-row flex-col relative  h-3/4 w-3/4 items-center text-center justify-between mt-20">
